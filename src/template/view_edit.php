 ...
 */
?>
<h1><?php echo sprintf(\$this->translate('{$this->getTranslationPrefix()}.edit.headline_html'), \$this->escapeHtml(\$this->{$this->getPropertyName()}->{$this->getToStringMethodName()}())); ?></h1>
<div class="btn-group">
    <a
